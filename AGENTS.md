...
- **Working Connector Examples**: `connectors/linear/`, `connectors/google/` (composite Gmail +
  Calendar connector — see `connectors/AGENTS.md` "Examples" for how its per-product modules are
  laid out), `connectors/slack/`, `connectors/jira/`
